...
/* GET users listing. */
router.options('*', cors.corsCheck, (req, res) => { res.sendStatus(200); 
  res.setHeader('Access-Control-Allow-Credentials', 'true');} )
router.get('/', cors.corsCheck, authenticate.verifyUser
...
router.put('/:userId',cors.corsCheck,authenticate.verifyUser,
function(req,res,next){
...
router.put('/password/:userId',cors.corsCheck,authenticate.verifyUser,
function(req,res,next){
...
router.post('/login',cors.corsCheck, passport.authenticate('local'), (req, res,next) => {
...
router.get('/checkJWTtoken', cors.corsCheck, (req, res) => {
